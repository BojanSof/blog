...
> One thing that I found useful with the FritzBox 7360SL, which has small amount of internal Flash memory, is to use small external USB drive to extend the root file system, to have storage for installing packages.
OpenWRT wiki has [tutorial](https://openwrt.org/docs/guide-user/additional-software/extroot_configuration) how to achieve this.
{: .prompt-info }
